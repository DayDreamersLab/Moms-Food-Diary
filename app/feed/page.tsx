      ...
      <div style={{ maxWidth:'700px', margin:'0 auto', padding:'2.5rem 1.5rem' }}>
        ...
        {loading ? (
          ...
          <div style={{ textAlign:'center', padding:'4rem' }}>
            ...
            <h3 style={{ fontFamily:"'Playfair Display', serif", fontSize:'1.5rem', color:'var(--deep-brown)' }}>No posts yet</h3>
            <p style={{ fontFamily:"'Caveat', cursive", color:'var(--warm-gray)', fontSize:'1.1rem' }}>Be the first to share a memory!</p>
          </div>
        ) : (
